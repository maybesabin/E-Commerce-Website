            ...
            <div className="lg:w-[80rem] w-full flex items-center justify-center flex-col gap-6">
                {isSubmit ? (
                    ...
                    <>
                        ...
                        <form className="flex sm:flex-nowrap flex-wrap items-center justify-center gap-4">
                            ...
                            <button type="submit" onClick={() => setIsSubmit(true)} className="uppercase md:text-[1rem] md:leading-5 text-xs bg-black md:h-12 h-9 md:w-32 w-24 text-white hover:bg-white hover:text-black transition-all">sign up</button>
                        </form>
